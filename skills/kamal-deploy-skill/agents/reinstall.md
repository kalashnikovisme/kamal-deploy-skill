...
```bash
claude plugins validate /home/pavel/projects/kamal-deploy-skill
```
...
cp -R /home/pavel/projects/kamal-deploy-skill/skills/kamal-deploy-skill ~/.claude/skills/kamal-deploy-skill
```
...
cp -R /home/pavel/projects/kamal-deploy-skill/skills/kamal-deploy-skill ~/.codex/skills/kamal-deploy-skill
```
...
- Run from the repository root: `/home/pavel/projects/kamal-deploy-skill`
